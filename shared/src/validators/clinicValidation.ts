...
const clinicCreateSchema = z.object({
    ...
    phone: z.string().regex(/^\d{10,15}$/, "O telefone deve conter entre 10 e 15 dígitos numéricos."),
    location: z.object({
...
const clinicUpdateSchema = z.object({
    name: z.string()
        ...
        .max(100, "O nome pode ter no máximo 100 caracteres.")
        .optional(),
    phone: z.string().regex(/^\d{10,15}$/, "O telefone deve conter entre 10 e 15 dígitos numéricos.").optional(),
    location: z.object({
